...
public class MazeElementsPanel extends JPanel{
	...
	public MazeElementsPanel(ManualMazeGeneratorWindow parent) {
		...
		elements.get(0).setIcon(new ImageIcon(MazeGraphics.wall));
		...
		elements.get(1).setIcon(new ImageIcon(MazeGraphics.heroUnarmed));
		...
		elements.get(2).setIcon(new ImageIcon(MazeGraphics.heroArmed));
		...
		elements.get(3).setIcon(new ImageIcon(MazeGraphics.dragonAwaken));
		...
		if(MazeGraphics.dragonSleeping != null)
			elements.get(4).setIcon(new ImageIcon(MazeGraphics.dragonSleeping));
		...
		elements.get(5).setIcon(new ImageIcon(MazeGraphics.sword));
		...
		if(MazeGraphics.exit != null)
			elements.get(6).setIcon(new ImageIcon(MazeGraphics.exit));
